...
# note that column 4 is Total Area, while column 3 is Total Nuclei
# fadu_data_all = read_excel("CBD screening_run 1_Nuclei count_SUM_raw data IS.xlsx") %>% select(1,2,4)
fadu_data_all = read_excel("CBD screening_run 1_Nuclei count_SUM_raw data IS.xlsx") %>% select(1,2,3)
...
# image saved as "unperturbed plate run 1 nuc count heatmap.png"
