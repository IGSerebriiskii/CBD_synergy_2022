...
# reading all data
cal27_data = read_excel("Cal27_CTB  run 2.xlsx",
...
ggsave("cal27 run 2 CTB summary.png")
...
cal27_drugs_vs_ctrl %>% write_csv("cal27_drugs_vs_ctrl run2 CTB.csv")
...
cal27_drugs_vs_ctrl_plot %>% write_csv("cal27_drugs_vs_ctrl_plot run2 CTB.csv")
