...
fadu_data = read_excel("run3 nuclear area.xlsx",
                       na = "#NA")

fadu_data %>% nrow() #1728 = 18*96
...
fadu_data_summary %>% write_csv("run3_nuclear_area_summary.csv")
...
ggsave("summary_violin run3 nucl_area.png",
...
# - - - - - - - - - - - - - - - - - - -
matrix(filter(fadu_data_mean,comp == 2000, cbd == "control")$Avg,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0, 100000, length.out = 100),  
         cellwidth = 15, cellheight = 15, fontsize = 8,  
         filename = "FADU run3 control nucl_area comp_2000nm avg.pdf")
matrix(filter(fadu_data_mean,comp == 200, cbd == "control")$Avg,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0, 100000, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU run3 control nucl_area comp_200nm avg.pdf")
matrix(filter(fadu_data_mean,comp == 5000, cbd == "control")$Avg,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0, 100000, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU run3 control nucl_area comp_5000nm avg.pdf")

matrix(filter(fadu_data_mean,comp == 2000, cbd == "cbd")$Avg,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0, 100000, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU run3 cbd nucl_area comp_2000nm avg.pdf")
matrix(filter(fadu_data_mean,comp == 200, cbd == "cbd")$Avg,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0, 100000, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU run3 cbd nucl_area comp_200nm avg.pdf")
matrix(filter(fadu_data_mean,comp == 5000, cbd == "cbd")$Avg,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0, 100000, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU run3 cbd nucl_area comp_5000nm avg.pdf")
...
ggsave("control vs cbd run3 nuclear_area conc2000 detailed with errorbars.png")
...
ggsave("control vs cbd run3 nuclear_area conc200 detailed with errorbars.png")
...
ggsave("control vs cbd run3 nuclear_area conc5000 detailed with errorbars.png")

matrix(filter(fadu_data_by_cbd_plot,comp == 5000)$ratio,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0.5, 1.5, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU run3 cbd nucl_area ratio comp_5000nm avg.pdf")
matrix(filter(fadu_data_by_cbd_plot,comp == 2000)$ratio,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0.5, 1.5, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU run3 cbd nucl_area ratio comp_2000nm avg.pdf")
matrix(filter(fadu_data_by_cbd_plot,comp == 200)$ratio,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0.5, 1.5, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU run3 cbd nucl_area ratio comp_200nm avg.pdf")
...
#  did not run block above for nuclear area
...
fadu_data_normalized = fadu_data_annotated %>% 
...
matrix(filter(fadu_data_norm_mean,comp == 2000, cbd == "control")$Avg,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0,2, length.out = 100),  
         cellwidth = 15, cellheight = 15, fontsize = 8,  
         filename = "FADU norm run3 nucl_area control comp_2000nm avg.pdf")

matrix(filter(fadu_data_norm_mean,comp == 5000, cbd == "control")$Avg,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0,2, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU norm run3 nucl_area control comp_5000nm avg.pdf")

matrix(filter(fadu_data_norm_mean,comp == 200, cbd == "control")$Avg,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0,2, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU norm run3 nucl_area control comp_200nm avg.pdf")

matrix(filter(fadu_data_norm_mean,comp == 2000, cbd == "cbd")$Avg,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0,2, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU norm run3 nucl_area cbd comp_2000nm avg.pdf")

matrix(filter(fadu_data_norm_mean,comp == 5000, cbd == "cbd")$Avg,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0,2, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU norm run3 nucl_area cbd comp_5000nm avg.pdf")

matrix(filter(fadu_data_norm_mean,comp == 200, cbd == "cbd")$Avg,8,12, byrow = T) %>% 
  pheatmap(cluster_rows = F,cluster_cols = F, breaks = seq(0,2, length.out = 100),  
           cellwidth = 15, cellheight = 15, fontsize = 8,  
           filename = "FADU norm run3 nucl_area cbd comp_200nm avg.pdf")
...
fadu_data_norm_by_cbd %>% 
  arrange(-comp, well_type) %>%  write_csv("fadu_data run3 nucl_area_norm_by_cbd.csv")
...
matrix(filter(fadu_data_norm_by_cbd,comp == 2000)$sign_values,8,12, byrow = T) %>%  
  pheatmap( cluster_rows = F, cluster_cols = F, cellwidth = 15, cellheight = 15,
         ...
         filename = "FADU run3 nucl_area cbd 2000 comp avg.pdf")
matrix(filter(fadu_data_norm_by_cbd,comp == 200)$sign_values,8,12, byrow = T) %>%  
  pheatmap( cluster_rows = F, cluster_cols = F, cellwidth = 15, cellheight = 15,
            breaks = seq(-1,1, length.out = 100),  
            filename = "FADU run3 nucl_area cbd 200 comp avg.pdf")
matrix(filter(fadu_data_norm_by_cbd,comp == 5000)$sign_values,8,12, byrow = T) %>%  
  pheatmap( cluster_rows = F, cluster_cols = F, cellwidth = 15, cellheight = 15, 
            breaks = seq(-1,1, length.out = 100),  
            filename = "FADU run3 nucl_area cbd 5000 comp avg.pdf")


matrix(filter(fadu_data_norm_by_cbd,comp == 2000)$sign_values,8,12, byrow = T) %>% 
  na_if(0) %>%   pheatmap( cluster_rows = F, cluster_cols = F, cellwidth = 15, cellheight = 15,
            breaks = seq(-1,1, length.out = 100),  
            filename = "FADU run3 nucl_area cbd 2000 sign diff.pdf")
matrix(filter(fadu_data_norm_by_cbd,comp == 200)$sign_values,8,12, byrow = T) %>%  
  na_if(0) %>%   pheatmap( cluster_rows = F, cluster_cols = F, cellwidth = 15, cellheight = 15,
            breaks = seq(-1,1, length.out = 100),  
            filename = "FADU run3 nucl_area cbd 200 sign diff.pdf")
matrix(filter(fadu_data_norm_by_cbd,comp == 5000)$sign_values,8,12, byrow = T) %>%  
  na_if(0) %>%   pheatmap( cluster_rows = F, cluster_cols = F, 
                           cellwidth = 15, cellheight = 15, 
            breaks = seq(-1,1, length.out = 100),  
            filename = "FADU run3 nucl_area cbd 5000 sign diff.pdf")
