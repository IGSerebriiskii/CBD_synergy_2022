...
pheatmap(fadu_v1,cluster_rows = F,cluster_cols = F)
pheatmap(fadu_v1,cluster_rows = F,cluster_cols = F, breaks = seq(50000, 250000, length.out = 100),  cellwidth = 15, cellheight = 15, fontsize = 8,  filename = "FADU norm run1 control comp_2000nm avg.pdf")
fadu_v2 = matrix(filter(fadu_data_norm_mean,comp == 200, cbd == "control")$Avg,8,12, byrow = T)
pheatmap(fadu_v2,cluster_rows = F,cluster_cols = F)
pheatmap(fadu_v2,cluster_rows = F,cluster_cols = F, breaks = seq(50000, 250000, length.out = 100),  cellwidth = 15, cellheight = 15, fontsize = 8,  filename = "FADU norm run1 control comp_2000nm avg.pdf")

fadu_cbd1 = matrix(filter(fadu_data_norm_mean,comp == 2, cbd == "cbd")$Avg,8,12, byrow = T)
pheatmap(fadu_cbd1,cluster_rows = F,cluster_cols = F)
pheatmap(fadu_cbd1,cluster_rows = F,cluster_cols = F, breaks = seq(50000, 250000, length.out = 100),  cellwidth = 15, cellheight = 15, fontsize = 8,  filename = "FADU norm run1 cbd comp_2000nm avg.pdf")

fadu_cbd2 = matrix(filter(fadu_data_norm_mean,comp == 200, cbd == "cbd")$Avg,8,12, byrow = T)
pheatmap(fadu_cbd2,cluster_rows = F,cluster_cols = F)
pheatmap(fadu_cbd2,cluster_rows = F,cluster_cols = F, breaks = seq(50000, 250000, length.out = 100),  cellwidth = 15, cellheight = 15, fontsize = 8,  filename = "FADU norm run1 cbd comp_200nm avg.pdf")
# note the "breaks..." part comes from the inspection of the unconstrained results
